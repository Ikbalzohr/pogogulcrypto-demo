...
export const Nav = () => {
  ...
  return (
    <div className="bg-white fixed left-0 right-0 z-10 py-2 ">
      <div className="px-4 items-center mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="relative flex items-center justify-between">
          <div className="flex items-center">
            <Link href="/">
              <a aria-label="Company" title="Company" className="inline-flex items-center mr-8 ">
                <Image src="/logo.png" alt="logo" width={50} height={50} className="border-2 rounded-full hover:rounded-sm" />
            ...
            <ul className="items-center hidden space-x-8 lg:flex">
              ...
              <li>
                <Link href="/#about">
                  <a aria-label="About us" title="About us" className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-indigo-300">
                    About us
                  </a>
                </Link>
              </li>
          ...
          <ul className="items-center hidden space-x-8 lg:flex">
            <li>
              <a
                href="/"
                className="inline-flex items-center justify-center h-9 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-indigo-300 hover:bg-indigo-700 focus:shadow-outline focus:outline-none"
                aria-label="Sign up"
                title="Sign up"
              >
                Sign In
            ...
            <li>
              <a href="/" aria-label="About us" title="About us" className="font-medium tracking-wide border-2 rounded-xl text-gray-700 transition-colors duration-200 hover:text-indigo-300">
                EN
              </a>
            </li>
          </ul>
          <div className="lg:hidden">
            ...
            {isMenuOpen && (
              <div className="absolute top-0 left-0 w-full z-10">
                <div className="p-5 bg-white border border-slate-400 rounded shadow-sm">
                  ...
                  <nav>
                    <ul className="space-y-4">
                      ...
                      <li>
                        <a href="#about" aria-label="About us" title="About us" className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-indigo-300">
                          About us
                        </a>
                      </li>
                      <li>
