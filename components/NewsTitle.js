...
const NewsTitle = () => {
  return (
    <div className="max-w-2xl px-5 py-4 mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
      ...
      <div className="mt-2">
        ...
        <p classNameName="mt-2 text-gray-600 dark:text-gray-300">Lorem ipsum dolor sit,</p>
      </div>
